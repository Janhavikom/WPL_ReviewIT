...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){ 
    ...
    $sql="SELECT * FROM `review_table` WHERE moviename='Ant Man'";
    $result=mysqli_query($conn,$sql); 
   ?>
<section>
		<div class="heading">ReviewIt</div>
		<div class="name glow"><?php echo "Ant Man" ?> </div>
    <br><br><br>
  <div id="review">
...
<section>
	...
	<a href="searchant.php" ><i style="color: white;" class='fas fa-edit'>Write a Review</i></a>
	</div>
</section>
