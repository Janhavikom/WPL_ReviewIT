...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){ 
    ...
    $sql="SELECT * FROM `review_table` WHERE moviename='Bohemian Rhapsody'";
    $result=mysqli_query($conn,$sql); 
   ?>
<section>
		<div class="heading">ReviewIt</div>
		<div class="name glow"><?php echo "Bohemian Rhapsody" ?> </div>
    <br><br><br>
  <div id="review">
...
<section>
	...
	<a href="searchboh.php" ><i style="color: white;" class='fas fa-edit'>Write a Review</i></a>
	</div>
</section>
