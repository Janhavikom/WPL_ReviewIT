...
<body>
	...
	<section>
		...
		<div class="name glow">Movies With Top Ratings</div>
		<br>
		<div class="wrapper">
			<?php
include_once('config.php');
$sql="SELECT * FROM review_table WHERE  rating=5 LIMIT 3";
//$sql="SELECT * FROM review_table WHERE moviename='Mulan'";
...
?>
	...
	<section>
		...
		<div class="body-review ">
			<form action="#" method="POST">
				...
				<div class="moviename">
					<textarea cols="10" placeholder="Movie Name" name="moviename"></textarea>
				</div><br>
				<div class="textarea">
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST")
		{
			...
			$sql = "INSERT INTO review_table (username,moviename,reviews,rating) VALUES ('$username','$moviename','$reviews','$rating')";
			if (mysqli_query($conn, $sql))
			{
				echo "New Rate added successfully". $rating;
			}
			else
			{
	...
	<section id="review">
		...
		<div class="review-box-container">
			...
			<?php
						include_once('config.php');
						$sql="SELECT * FROM review_table LIMIT 8";
						$result=mysqli_query($conn,$sql);
						$num = mysqli_num_rows($result);
                        if ($num >0){
                        while ($row =mysqli_fetch_assoc($result)){
